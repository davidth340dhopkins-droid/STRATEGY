...
$outputDir    = "$strategyRoot\gardener\entities"
$indexCsv     = "$outputDir\_index.csv"
$indexJson    = "$outputDir\_index.json"
$indexMd      = "$outputDir\_index.md" 
...
$latestTemplate = Get-ChildItem -Path $templatesDir -Directory | Where-Object { $_.Name -match "^v\d+$" } | Sort-Object { [int]($_.Name -replace "v","") } -Descending | Select-Object -First 1
...
$latestFiles = Get-ChildItem -Path $sourceDirs -Filter "*.md" -Recurse | Where-Object { $_.Name -ne "_index.md" -and $_.Name -ne "README.md" }
...
$allFilesForChildren = Get-ChildItem -Path $sourceDirs -Filter "*.md" -Recurse | Where-Object { $_.Name -ne "_index.md" -and $_.Name -ne "README.md" }
$parentToChildren = @{}
...
foreach ($dir in $sourceDirs) {
    ...
    Get-ChildItem -Path $dir -Filter "*.md" | Where-Object { $_.Name -ne "_index.md" -and $_.Name -ne "README.md" } | ForEach-Object {
        ...
        $tp = "$templatesDir\v$vNum\entity.md"
