...
# 1. Modify the FIELDS below (e.g., set master, description, etc.).
...
template_version: 33 # Managed by build-index.ps1. Do not edit.
...
# [ master ] ----------------------------------------------------------------- #
# Key of the parent/master project. (e.g. "life-plan")
master: ""
# ---------------------------------------------------------- #
...
> **Master:** {{master}} · {{type}} · {{category}} · {{key}}
